...
<ul>
  <li>The first step in here is to create out user in <i>AWS Console</i>. To do it, go to <b><i>IAM (Identity and Access Management)</i></b>, then select <b><i>Users</i></b> from the list menu on the left.</li>
