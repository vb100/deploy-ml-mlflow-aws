...
Prepare the alternative table of your own parameters also.
  ...
  <ul>
    ...
    <ul>
      ...
      <li>From the list below select <b><i>Elastic Container Registry</i></b>, see the screenshot below.<br>
      <img src="images/Screenshot 2021-08-30 at 00.45.06.png" alt="ECR Policy to the User", width=605><br>
